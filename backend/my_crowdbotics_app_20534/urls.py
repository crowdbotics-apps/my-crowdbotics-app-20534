"""my_crowdbotics_app_20534 URL Configuration
...
admin.site.site_header = "My Crowdbotics App"
admin.site.site_title = "My Crowdbotics App Admin Portal"
admin.site.index_title = "My Crowdbotics App Admin"

# swagger
api_info = openapi.Info(
    title="My Crowdbotics App API",
    default_version="v1",
    description="API documentation for My Crowdbotics App App",
)
